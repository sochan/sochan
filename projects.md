		...
		<section>
			...
			<div class="content">
				<div class="inner">
					...
					<p> There are 12 levels for this game, each level kid can play many times due to when they win a game level the player still can play again and again to see other colour because the colours were randomed to play. Furthermore, during the play, parents can enable sounds, those sounds can help kids quickly fall asleep during play this game. Kids can click on each colour basket to listen to the voice saying each colour. There are animations and sounds while game over, won game or timeout. Technologies: HTML, JavaScript, CSS.
